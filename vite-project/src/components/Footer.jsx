      ...
      <div className="flex justify-around">
        ...
        <div className="">
          ...
          <ul className="">
            ...
            <li className="pb-1">Politique de remboursement</li>
            <li className="pb-1">Politique de confidentialité</li>
            <li className="pb-1">Carrières</li>
          </ul>
        </div>
        ...
        <div className="">
          ...
          <ul>
            ...
            <li className="flex pb-2">
              ...
              71 rue Reine Elisabeth, 71000 Metz
            </li>
